...
def mail(request):
    ...
    next(reader, None)  # safe header skip
    ...
    for row in reader:
        ...
        body = f"Dear {first_name} {salutation},\n\n{message}"
        ...
        try:
            ...
            if 'attachment' in request.FILES:
                attachments.extend(request.FILES.getlist('attachment'))
            if 'attachment2' in request.FILES:
                attachments.extend(request.FILES.getlist('attachment2'))
